...
![渲染引擎工作原理](assets/flow.png)


**WebKit工作原理（Chrome、Safari、Opera）**

![Blink渲染引擎工作原理](assets/webkitflow.png)


**Gecko工作原理（FireFox）**

![Gecko渲染引擎工作原理](assets/gecko.jpg)
...
![第一步](assets/chrome_rendering1.png)

第二步：

![第二步](assets/chrome_rendering2.png)
...
![http请求报文和响应报文](assets/HTTPMsgStructure2.png)
...
![Dom 解析工作原理](assets/dom.png)



## Webkit CSS 解析

![CSS 解析工作原理](assets/css_parser.png)
